                        ...
                        <table>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><span>{{ \App\User::numeroslice( \App\User::encrypt_decrypt('decrypt',$group->numero)) }}</span></td>
                              <td><span>@if($group->email){{ \App\User::correoslice(\App\User::encrypt_decrypt('decrypt',$group->email)) }} @endif</span></td>
