              ...
              <section class="section1">
                <div class="section1__align">
                  <div class="section1__header">
                    <div class="links"><a class="btnBack" href="#"> <span>Volver</span></a><a class="btnClose" href="#"> <span>Cerrar sesión</span></a></div>
                    <div class="title">
              ...
              <section class="section2">
                <div class="section2__align">
                  <div class="section2__main">
                    ...
                    <div class="grid">
                      <div class="grid__actions"><a @click="showModal()"> <img src="assets/pg4_icon_add.svg" alt=""/><span>Agregar miembro</span></a><a> <img src="assets/pg4_icon_leader.svg" alt=""/><span>Cambiar líder</span></a><a> <img src="assets/pg4_icon_clean.svg" alt=""/><span>Eliminar miembro</span></a></div>
                    ...
                    <section class="section1">
                      <div class="section1__header">
                        <div class="title ico_check">
                          <h2>¿Está seguro que desea eliminar a IRONMAN de la mancha?</h2>
                        </div>
                      </div>
                      <div class="section1__main">
                        <div class="register">
                          <form class="form" action="">
                            <div class="form__row3">
                              <div class="form__buttons">
                                <button class="button1" type="button" @click="closeModal()">Si</button>
                                <button class="button1" type="button" @click="closeModal()">No</button>
                              </div>
                            </div>
                          </form>
                        </div>
